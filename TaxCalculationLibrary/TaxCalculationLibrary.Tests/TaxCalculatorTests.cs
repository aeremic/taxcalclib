...
public class TaxCalculatorTests
{
    ...
    [Test, Order(2)]
    public void SetCustomTaxRate_ShouldSetCustomRate_ReturnsFirstCustomRate()
    {
    ...
    [Test, Order(5)]
    public void GetCurrentTaxRate_ShouldGetDefaultRate_ReturnsDefaultRate()
    {
        var firstCustomRateValue = _taxCalculator!.GetCurrentTaxRate(Enums.Commodity.Transport);

        Assert.That(firstCustomRateValue, Is.EqualTo(0.6));
    }
}